...
```powershell
python .\cli_assistant.py --base-url https://api.openai.com/v1 --api-key sk-... --model gpt-4.1-mini
```
...
```powershell
python .\cli_assistant.py --base-url https://api.openai.com/v1 --api-key sk-... --model gpt-4.1-mini --save-config
```
