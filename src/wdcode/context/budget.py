...
class ContextBudget:
    ...
    max_symbol_index_chars: int = 4000
...
def apply_context_budget(
    *,
    ...
    symbol_index_text, symbol_index_truncated = apply_char_budget(
        symbol_index_text,
        budget.max_symbol_index_chars,
        label="symbol_index",
    )
    ...
    return context_text, {
        ...
        "symbol_index_truncated": symbol_index_truncated,
