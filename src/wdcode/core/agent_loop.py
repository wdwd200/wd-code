...
def run_agent_turn(
    ...
    for _ in range(max_rounds):
        ...
        content, calls_executed = _handle_assistant_message(
            conversation,
            assistant_message,
            tool_gateway,
...
def _handle_assistant_message(conversation, assistant_message, tool_gateway, trace_writer=None):
    ...
    for tool_call in tool_calls:
        ...
        tool_result = tool_gateway.handle(tool_call).to_dict()
